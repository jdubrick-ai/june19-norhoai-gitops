...
# Application
An application built from https://github.com/jdubrick-ai/june19-norhoai will be stored in [quay.io/jdubrick-ai/june19-norhoai](https://quay.io/jdubrick-ai/june19-norhoai) and deployed through GitOps. This application is accessible on port **8501**.